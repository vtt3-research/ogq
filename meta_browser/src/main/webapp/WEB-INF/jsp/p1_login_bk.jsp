    ...
    <script>
        function goLoginOK(){
            ...
            if($(".txt_message").text().length==0){
                window.location.href="${pageContext.request.contextPath}/content/allList";
                // TODO: 개발용 링크 제거
                $('form').submit();
            }else{
            }
        ...
        function checkLoginForm() {
            str0="";
            str1= "* 존재하지 않는 아이디 입니다.";
            str2="* 아이디를 입력해주세요.";
            str3="* 입력한 비밀번호가 일치하지 않습니다.";
            str4="* 비밀번호를 입력해주세요.";
            str5="* 아이디를 입력해주세요.";
        ...
        <div class="wide-modal-content">
            <div class="modal-body">
                ...
                <dl class="item-dl">
                    ...
                    <dd>
                        <div class="wrap_inp">
                            <input class="input6" type="text" id="pi1" name="pi1" value="" placeholder="가입 시 입력한 소속 기관 또는 회사명"
                ...
                <dl class="item-dl">
                    ...
                    <dd>
                        <div class="wrap_inp">
                            <input class="input6" type="text" id="pi2" name="pi2" name="organ" value="" placeholder="가입시 입력한 서비스 내에서 표시될 이름"
                                   onkeyup='valChecker($(this),32, $("#byteLength2"));'>
                            <br/><span id="byteLength2" class="small-bytes-font">0 / 32</span>
                        </div>
                    </dd>
                </dl>
                <p id="caution1" class="txt_message_loginpopup">* 필수입력</p>
                <dl class="item-dl">
                    <dt><label class="lab_info">이메일</label></dt>
                    <dd>
                        <div class="wrap_inp">
                            <input class="input6" type="text" id="pi3" name="pi3" name="organ" value="" placeholder="아이디를 받을 이메일 주소"
                                   onkeyup='valChecker($(this),128, $("#byteLength3"));'>
                            <br/><span id="byteLength3" class="small-bytes-font">0 / 128</span>
                        </div>
                    </dd>
                </dl>
                <p id="caution2" class="txt_message_loginpopup">* 필수입력</p>
                <div style="margin: 10px;">
                    <button onclick="goFindID()" class="large-button">확인</button>
                </div>
