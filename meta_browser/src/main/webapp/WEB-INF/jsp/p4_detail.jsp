...
<%
    ...
    AccountVO myAccountVO = (AccountVO)request.getSession().getAttribute("myAccountVO");
...
<main>
    <script type="text/javascript">
        <%if(contentVO.getEntireTags().length()==0){%>showSnackbar('비디오에 포함된 태그가 없습니다.');<%}%>
...
<%if(myAccountVO.getAccountId().equals(contentVO.getAccountId())){%>                <button class="white36-button" onclick="showModal('editModal');">정보수정</button>
<%}%>
